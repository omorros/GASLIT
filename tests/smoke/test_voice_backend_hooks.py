...
def main() -> int:
    ...
    other_room = _voice_ids("forensic_room", "The VIP refund is auto-approved.")
    ...
    assert first[3] != other_room[3], "different rooms need distinct memory IDs"
    assert first[3].startswith("m_voice_"), "voice memories should keep memory_id shape"
