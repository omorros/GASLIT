...
def _needs_dossier(doc: dict) -> bool:
    """A Sentinel explanation is not the final Forensic Auditor dossier."""
    return bool(doc.get("quarantine_id") and doc.get("memory_id")
                and not doc.get("dossier_composed_at"))
