...
def demo_trigger_drift(req: TriggerDriftReq) -> TriggerDriftResp:
    ...
    return TriggerDriftResp(
        ...
        inserted=inserted,
        note=(
            "Appended synthetic retrievals without clearing audit or quarantine history. "
            "Sentinel will evaluate drift on Change Stream; poll /api/memories and /api/sentinel-status."
        ),
    )
