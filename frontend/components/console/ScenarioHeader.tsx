...
export function ScenarioHeader({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        {error && (
          <p className="max-w-[320px] truncate rounded-full border border-red-200 bg-red-50 px-3 py-1.5 text-[11.5px] font-medium text-red-700">
            Scenario backend error: {error}
          </p>
        )}
        {currentDay === 0 && (
